...
abstract class FlowLogic<out T> {
     ...
     */
    @Throws(FlowException::class)
    fun checkFlowPermission(permissionName: String, extraAuditData: Map<String, String>): Unit = stateMachine.checkFlowPermission(permissionName, extraAuditData)
     ...
     * @param extraAuditData in the audit log for this permission check these extra key value pairs will be recorded.
     */
    fun recordAuditEvent(eventType: String, comment: String, extraAuditData: Map<String, String>): Unit = stateMachine.recordAuditEvent(eventType, comment, extraAuditData)
