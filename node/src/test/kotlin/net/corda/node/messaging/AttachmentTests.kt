...
class AttachmentTests {
    ...
    fun `download and store`() {
        ...
        mockNet.runNetwork()
        val f1 = n1.services.startFlow(FetchAttachmentsFlow(setOf(id), n0.services.legalIdentity.party))
        mockNet.runNetwork()
        ...
        val response: FetchDataFlow.Result<Attachment> = n1.services.startFlow(FetchAttachmentsFlow(setOf(id), n0.services.legalIdentity.party)).resultFuture.getOrThrow()
    ...
    fun `missing`() {
        ...
        mockNet.runNetwork()
        val f1 = n1.services.startFlow(FetchAttachmentsFlow(setOf(hash), n0.services.legalIdentity.party))
        mockNet.runNetwork()
