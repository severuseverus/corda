...
object FixingFlow {
    ...
    class Fixer(override val otherParty: Party) : TwoPartyDealFlow.Secondary<FixingSession>() {
        ...
        @Suspendable
        override fun assembleSharedTX(handshake: TwoPartyDealFlow.Handshake<FixingSession>): Triple<TransactionBuilder, List<PublicKey>, List<DigitalSignature.WithKey>> {
